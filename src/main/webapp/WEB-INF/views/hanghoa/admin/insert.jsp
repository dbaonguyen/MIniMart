...
<nav
	...
	<h1><s:message code="label.product.add"></s:message></h1>
	<span class="box-ok">${msg}</span>
	<span class="box-error">${msgErr}</span>
	<sf:form action="${rootPath}hanghoa/admin/insert" method="post"
		modelAttribute="hh">
		...
		<input type="submit" value="<s:message code="label.product.add"></s:message>">
	</sf:form>
	<br>
	<a href="${rootPath}hanghoa/admin" class="button"><i class="fa-solid fa-house fa-xl"></i></a>
</body>
</script>
