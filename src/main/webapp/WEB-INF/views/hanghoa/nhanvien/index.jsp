...
<body>
	...
	<form action="${rootpath}hanghoa/nhanvien/search" method="get">
		<div class="d-flex">
			...
			<div class="ml-auto">
				<a href="${rootpath}/hanghoa/nhanvien/initInsert" class="button"><s:message code="label.addnew"></s:message></a>
			</div>
		...
		<c:forEach items="${lst}" var="hh">
			<tr>
				...
				<td><fmt:formatDate value="${hh.ngaycapnhat}"
						dateStyle="MEDIUM" /></td>
				<td><a href="${rootpath}hanghoa/nhanvien/init-update?idhh=${hh.id}"><i
						class="fa-solid fa-pen-to-square fa-lg" style="color: #2562cb;"></i></a></td>
				<td><a href="#"
					onclick="confirmDelete('${rootpath}hanghoa/nhanvien/delete?idhh=${hh.id}')"><i
