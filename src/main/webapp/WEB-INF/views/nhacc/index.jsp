...
<body>
	...
	<h1><s:message code="label.producer.manage"></s:message></h1>
	<span class="box-ok">${msg}</span>
	<span class="box-error">${msgErr}</span>
	<form action="${rootpath}nhacc" method="get">
		<div class="d-flex">
			<div class="search_container">
			<input type="text" maxlength="50" name="search"
				placeholder="<s:message code="label.suppliername"></s:message>" />
			<a type="submit" style="color: white;" class="button"><i class="fa-solid fa-magnifying-glass"></i></a>
			</div>
			<div class="ml-auto">
				<a href="${rootpath}nhacc/initInsert" class="button"><s:message code="label.addnew"></s:message></a>
			</div>
	...
	<div class="table-responsive-sm" style="overflow-x: auto;">
		...
		<c:forEach items="${lst}" var="ncc">
			<tr>
				...
				<td>${ncc.fax}</td>
				<td>${ncc.email}</td>
				<td><a href="${ncc.website}">${ncc.website}</a></td>
				...
				<td><a href="${rootpath}nhacc/init-update?idncc=${ncc.id}"><i
						class="fa-solid fa-pen-to-square fa-lg" style="color: #2562cb;"></i></a></td>
				<td><a href="#"
					onclick="confirmDelete('${rootpath}nhacc/delete?idncc=${ncc.id}')"><i
