...
<body>
	...
	<h1><s:message code="label.producer.update"></s:message></h1>
	<span class="box-ok">${msg}</span>
	<span class="box-error">${msgErr}</span>
	<sf:form action="${rootPath}nhacc/update" method="post"
		modelAttribute="ncc">
		...
		<input type="submit" value="<s:message code="label.producer.update"></s:message>">
	</sf:form>
