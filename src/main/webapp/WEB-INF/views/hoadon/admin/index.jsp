...
<body>
	...
	<form action="${rootpath}hoadon/admin/search" method="get">
		<div class="d-flex">
			...
			<c:forEach items="${lst}" var="hd">
				<tr>
					...
					<td style="text-align: center;"><a
						href="${rootpath}hoadon/admin/hoadonchitiet?idhd=${hd.id}"> <i
							class="fa-solid fa-info fa-xl icon" style="color: #2562cb;"></i>
					</a></td>
					 <td style="text-align: center;"><a href="${rootpath}hoadon/admin/init-update?idhd=${hd.id}"><i
