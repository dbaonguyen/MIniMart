...
<body>
	...
	<h1>Cập nhật thông tin hóa đơn</h1>
	<span class="box-ok">${msg}</span>
	<span class="box-error">${msgErr}</span>
	<sf:form action="${rootPath}hoadon/nhanvien/update" method="post"
		modelAttribute="hd">
		...
		<input type="submit" value="Cập nhật thông tin hóa đơn">
	</sf:form>
	<br>
	<a href="${rootPath}hoadon/nhanvien" class="button"><i class="fa-solid fa-house fa-xl"></i></a>
</body>
