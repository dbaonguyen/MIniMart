...
<nav
	...
	<h1><s:message code="label.employee.add"></s:message></h1>
	<span class="box-ok">${msg}</span>
	<span class="box-error">${msgErr}</span>
	<sf:form action="${rootPath}nhanvien/insert" method="post"
		modelAttribute="nv">
		...
		<input type="submit" value="<s:message code="label.employee.add"></s:message>">
	</sf:form>
	<br>
