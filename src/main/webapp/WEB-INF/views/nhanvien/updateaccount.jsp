...
<h1><s:message code="label.employee.update"></s:message></h1>
	...
	<sf:form action="${rootPath}nhanvien/updateaccount" method="post" modelAttribute="nv">
		<table border="1" class="table table-bordered table-hover">
			...
			<tr>
				...
				<td><sf:radiobutton path="gioitinh" name = "gioitinh" label="Male" value = "1"/><sf:radiobutton path="gioitinh" name = "gioitinh" label="Female" value = "0"/></td>
				<td><sf:errors path="gioitinh" cssClass="box-error"></sf:errors></td>
			</tr>
			<tr style="display: none;">
				<th><s:message code="label.role"></s:message></th>
				<td style="text-align: center;"><strong>${nv.phanQuyen.tenquyen}</strong></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><sf:input type="date" path="ngayvaolam" readonly="true"/></td>
			</tr>
			<tr>
			...
			<tr style="display: none;">
				...
				<td><sf:input path="luongcoban" type="number" readonly="true"/></td>
				<td><sf:errors path="luongcoban" cssClass="box-error"></sf:errors></td>
			</tr>
			<tr>
				<th>Username</th>
				<td><sf:input type="text" path="username" readonly="true"/></td>
			...
			<tr style="display: none;">
				...
				<td><sf:input path="ghichu" type="text" readonly="true"/></td>
				<td><sf:errors path="ghichu" cssClass="box-error"></sf:errors></td>
			</tr>
			<tr style="display: none;">
				<th><s:message code="label.status"></s:message></th>
				<td><sf:radiobutton path="trangthai" label="Active" value="1" name="trang_thai" readonly="true"/>
					<sf:radiobutton path="trangthai" label="Non-Active" value="0" name="trang_thai" readonly="true"/></td>
	...
	<a href="${rootPath}home/nhanvien" class="button"><i class="fa-solid fa-house fa-xl"></i></a>
</body>
