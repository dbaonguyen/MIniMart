...
<body>
	...
	<form action="${rootpath}khachhang/nhanvien/search" method="get">
		<div class="d-flex">
			...
			<div class="ml-auto">
				<a href="${rootpath}/khachhang/nhanvien/initInsert" class="button"><s:message code="label.addnew"></s:message></a>
			</div>
	...
	<div class="table-responsive-sm" style="overflow-x: auto;">
		...
		<c:forEach items="${lst}" var="kh">
			<tr>
				...
				<td><a href="${rootpath}khachhang/nhanvien/init-update?idkh=${kh.id}"><i
						class="fa-solid fa-pen-to-square fa-lg" style="color: #2562cb;"></i></a></td>
				<td><a href="#"
					onclick="confirmDelete('${rootpath}khachhang/nhanvien/delete?idkh=${kh.id}')"><i
