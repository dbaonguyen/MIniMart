...
<body>
	...
	<h1><s:message code="label.customer.manage"></s:message></h1>
	<span class="box-ok">${msg}</span>
	<span class="box-error">${msgErr}</span>
	<form action="${rootpath}khachhang/admin/search" method="get">
		<div class="d-flex">
			...
			<div class="ml-auto">
				<a href="${rootpath}/khachhang/admin/initInsert" class="button"><s:message code="label.addnew"></s:message></a>
			</div>
	...
	<div class="table-responsive-sm" style="overflow-x: auto;">
		...
		<c:forEach items="${lst}" var="kh">
			<tr>
				<td>${kh.id}</td>
				<td>${kh.ho}</td>
				<td>${kh.ten}</td>
				<td>${(kh.gioi_tinh == 1)? "Male": "Female"}</td>
				...
				<td><a href="${rootpath}khachhang/admin/init-update?idkh=${kh.id}"><i
						class="fa-solid fa-pen-to-square fa-lg" style="color: #2562cb;"></i></a></td>
				<td><a href="#"
					onclick="confirmDelete('${rootpath}khachhang/admin/delete?idkh=${kh.id}')"><i
