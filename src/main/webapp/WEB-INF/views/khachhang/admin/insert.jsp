...
<nav
	...
	<h1><s:message code="label.customer.add"></s:message></h1>
	<span class="box-ok">${msg}</span>
	<span class="box-error">${msgErr}</span>
	<sf:form action="${rootPath}khachhang/admin/insert" method="post"
		modelAttribute="kh">
	...
	<br>
	<a href="${rootPath}khachhang/admin" class="button"><i class="fa-solid fa-house fa-xl"></i></a>
</body>
</script>
