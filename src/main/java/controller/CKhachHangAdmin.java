...
@Controller
@RequestMapping("/khachhang/admin")
public class CKhachHangAdmin {
	@RequestMapping(value = { "", "/" }, method = RequestMethod.GET)
	public String index(Model m) {
		List<KhachHang> lstkh = loadData();
		m.addAttribute("lst", lstkh);

		return "khachhang/admin/index";
	}
	...
	public String initInsert(Model m) {
		...
		return "khachhang/admin/insert";

	}

	@RequestMapping(value = "/insert", method = RequestMethod.POST)
	public String insert(@Valid @ModelAttribute("kh") KhachHang kh, BindingResult result, Model m, Locale locale) {
	...
	public String initUpdate(@RequestParam(name = "idkh") int idkh, Model m) {
		...
		return "khachhang/admin/update";
	}

		@RequestMapping(value = "/update", method = RequestMethod.POST)
		public String update(@Valid @ModelAttribute("kh") KhachHang kh, BindingResult result, Model m, Locale locale) {
			IKhachHangDAO dao = new ImplKhachHangDAO();
			if (result.hasErrors()) {
				m.addAttribute("kh", kh);
				return "khachhang/admin/update";
	...
	public String delete(@ModelAttribute("idkh") int idkh, Model m, Locale locale) {
		IKhachHangDAO dao = new ImplKhachHangDAO();
